    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #3E88EF;" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="poolbar-dokumen.php">Dokumen</a>
                 ...
                 <li class="nav-item">
                    <a class="nav-link " href="bo-kabid.php" >
                        <span class="text-light">KABID</span>
                    </a>
                </li>
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <td>
                        <span><button class="btn btn-success" width="555"height="85">Ya</button></span>
