    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #3E88EF;" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="inskal-kabid.php">Kasubid</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item " href="poolbar-dokumen.php">Dokumen</a>
                            <a class="collapse-item active " href="poolbar-kabid.php">Kasubid</a>
                    </div>
                </li>

                <li class="nav-item">
                    <a class="nav-link active " href="bo-kabid.php" >
                        <span>KABID</span>
                    </a>
                </li>
...
<!-- End of Sidebar -->
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                    <td>Hanif Kurniawan</td>
                    <td><a href="file1.pdf" download>File 1</a></td>
                    <td><span><button class="btn btn-success" width="555"height="85">Ya</button></span>
                        <span> <button class="btn btn-danger" width="555"height="85" >Tidak</button></span>
                    </td>
                    <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#komentarModal">
                    Tambahkan Keterangan
                        </button></td>
                    <td><a href="file1.pdf" download>Download</a></td>
                    </tr>
                    <tr>
                    <td>Dwi Indra Prasetyo</td>
                    ...
                    <td><a href="file2.pdf" download>Download</a></td>
                    </tr>
